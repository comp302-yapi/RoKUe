...
public class HallPanel extends PlayablePanel {
	...
	public TileManagerForHall getTileM() {
		return this.tileM;
	}
	...
	public CollisionCheckerForHall getCollisionCheckerForHall() {
	...
	public void paintComponent(Graphics g) {
		...
		case HallOfEarth -> {
			...
			Image scaledImage = backgroundImage.getImage().getScaledInstance(this.getWidth(), this.getHeight(),
					Image.SCALE_SMOOTH);
